...
\begin{tabular}{l|c|c|c}
	...
	\rotatebox{90}{\hspace*{.1cm} Combinatorics} &  \includegraphics[scale=.3]{weakOrder} & \includegraphics[scale=.23]{TamariLattice} & \includegraphics[scale=.35]{/booleanLattice} \\
...
As previously described, we have two families of interesting structures, the Cambrian lattices and the Permutree lattices, both generalizing the Tamari lattice. They overlap in the sense that the Cambrian lattices of type $A$ are a specific case of Permutree lattices. They correspond to a decoration $\delta \in \lbrace \upCirc, \downCirc \rbrace^n$. The problem of defining Permutree lattices for other types has never been studied.
...
\item UQAM Montréal, Canada (F. Bergeron, F. Saliola, C. Reutenauer)
...
\item Université de Marne la Vallée (J.-C. Novelli et J.-Y. Thibon)
\end{compactitem}
